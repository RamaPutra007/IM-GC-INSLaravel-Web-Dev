...
*/
    ...
    $juml_kata_first = str_word_count($first_sentence);
    echo "first sentence = panjang string : $panjang_first, jumlah kata : $juml_kata_first";
    echo "<br>";
    echo "<br>";
    $panjang_second = strlen($second_sentence);
    $juml_kata_second = str_word_count($second_sentence);
    echo "second_sentence = panjang string :  $panjang_second, jumlah kata : $juml_kata_second";
    ...
    echo "String: \"$string3\" "; // OUTPUT : "PHP is old but awesome" 
